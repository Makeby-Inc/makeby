...
export const fleaMarketRegisterDto = z
	.object({
		productImages: z
			.array(z.string())
...
export type FleaMarketRegisterDto = z.infer<typeof fleaMarketRegisterDto>

export const fleaMarketFormDefaultValue = {
	productImages: [],
	title: '',
	tradeType: 'SELL',
	price: null,
	...
	description: '',
	tags: []
} satisfies FleaMarketRegisterDto
